...
const testData = {
  weeklyReport: {
    ...
    newSkus: '156',
    newCompanies: '8',
    topFiler: 'Diageo Americas Supply Inc',
    topFilerCount: '34',
    categoryData: [
    ...
    topCompaniesList: [
      { company: 'Diageo Americas Supply Inc', category: 'Whiskey', filings: 34 },
      { company: 'Constellation Brands U.S. Operations Inc', category: 'Beer', filings: 28 },
      { company: 'Pernod Ricard USA LLC', category: 'Whiskey', filings: 22 },
      { company: 'E. & J. Gallo Winery', category: 'Wine', filings: 19 },
      { company: 'Brown-Forman Corporation', category: 'Whiskey', filings: 16 },
    ],
    topExtensionsList: [
      { brand: 'Crown Royal', company: 'Diageo Americas Supply Inc', category: 'Whiskey', newSkus: 14 },
      { brand: 'High Noon', company: 'E. & J. Gallo Winery', category: 'RTD', newSkus: 9 },
      { brand: 'Modelo Especial', company: 'Constellation Brands U.S. Operations Inc', category: 'Beer', newSkus: 8 },
      { brand: "Titos", company: 'Fifth Generation Inc', category: 'Vodka', newSkus: 6 },
      { brand: "Hendricks", company: 'William Grant & Sons Inc', category: 'Gin', newSkus: 5 },
    ],
    notableNewBrandsPreview: [
      { brand: 'Codigo 1530', company: 'Codigo US LLC', category: 'Tequila' },
      { brand: 'Kentucky Owl', company: 'Stoli Group USA LLC', category: 'Whiskey' },
      { brand: 'Cutwater', company: 'Cutwater Spirits LLC', category: 'RTD' },
    ],
  ...
  proWeeklyReport: {
    ...
    topCompaniesList: [
      ...
      { company: 'Constellation Brands U.S. Operations Inc', filings: 67, change: '+12' },
      { company: 'Pernod Ricard USA LLC', filings: 54, change: '+8' },
